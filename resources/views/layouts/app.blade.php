...
<head>
    ...
    <!-- JQuery -->
    <script type="text/javascript" src="{{asset('/js/3_2_1_jquery.min.js')}}"></script>
    <!-- Bootstrap tooltips -->
    <script type="text/javascript" src="{{asset('/js/popper.min.js')}}"></script>
    <!-- Bootstrap core JavaScript -->
    <script type="text/javascript" src="{{asset('/js/4_0_0_js_bootstrap.min.js')}}"></script>
    ...
    <script src="{{asset('/js/3_3_1_jquery.min.js')}}"></script>
</head>
<body>
    <div id="app">
