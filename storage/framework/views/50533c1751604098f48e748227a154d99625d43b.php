...
<center>
 <div class="panel panel-primary">
        ...
        <div class="panel-body">            
            <div class="row">
             <div class="col-lg-4">
                    <img class="img-circle" src="<?php echo e(URL::asset('/images/quantitative.png')); ?>" alt="Generic placeholder image" style="width: 140px; height: 140px;">
                    <h3>Quantitative Aptitude</h3>
                     
                    <p><a class="btn btn-default" href="<?php echo e(url('/quanti')); ?>" role="button">Take The Test &raquo;</a>
                    </p>
                </div>
                <div class="col-lg-4">
                    ...
                    <p><a class="btn btn-default" href="<?php echo e(url('/verbal')); ?>" role="button">Take The Test &raquo;</a>
                    </p>
                </div>
                <div class="col-lg-4">
                    <img class="img-circle"  src="<?php echo e(URL::asset('/images/coding.png')); ?>" alt="Generic placeholder image" style="width: 140px; height: 140px;">
                    <h3>Coding Decoding</h3>
                     
                    <p><a class="btn btn-default" href="<?php echo e(url('/code')); ?>" role="button">Take The Test &raquo;</a>
                    </p>
                </div>
                <div class="col-lg-7">
                    ...
                    <p><a class="btn btn-default" href="<?php echo e(url('/technical')); ?>" role="button">Take The Test &raquo;</a>
                    </p>
                </div>
                <div class="col-lg-3">
                    ...
                    <p><a class="btn btn-default" href="<?php echo e(url('/logic')); ?>" role="button">Take The Test &raquo;</a>
                    </p>
                </div>
