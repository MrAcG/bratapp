...
<div class="w3-content w3-section" style="max-width:500px">
  ...
  <img class="mySlides w3-animate-fading" src="<?php echo e(URL::asset('/images/tm2.jpeg')); ?>" style="width:100%">
...
<p align="center"><a class="btn btn-default" href="<?php echo e(url('/select4')); ?>" role="button">Take The Test</a>
</p>
            </div>
            </div>
            <!-- /.row -->
