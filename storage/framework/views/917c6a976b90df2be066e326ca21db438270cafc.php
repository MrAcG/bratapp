    ...
    <div class="row">
     ...
     <div class="panel panel-primary">
        <div class="panel-heading">
            <h2 class="panel-title" align="center">Time Management</h2>
        </div>
...
function carousel() {
    ...
    setTimeout(carousel, 9000);    
            ...
            <p>It seems that there is never enough time in the day. But, since we all get the same 24 hours, why is it that some people achieve so much more with their time than others? The answer lies in good time management.
...
<h4><b>What is “Time Management?”</b></h4>	
<p>
...
<ul>
<li><span>Greater productivity and efficiency.</span></li>
   <li>A better professional reputation.</li> 
    <li>Less stress.</li>
   <li> Increased opportunities for advancement.</li>
   <li> Greater opportunities to achieve important life and career goals.
    </li>
</ul>
...
<h2><b>Time Management Factors</b></h2>
<p>
...
<br><b><u><i>2.	Planning/Scheduling:</i></b></u>
