...
<div class="w3-content w3-section" style="max-width:500px">
  <img class="mySlides w3-animate-fading" src="<?php echo e(URL::asset('/images/ld1.jpeg')); ?>" style="width:100%">
  <img class="mySlides w3-animate-fading" src="<?php echo e(URL::asset('/images/ld2.jpeg')); ?>" style="width:100%">
  <img class="mySlides w3-animate-fading" src="<?php echo e(URL::asset('/images/ld3.jpeg')); ?>" style="width:100%">
  <img class="mySlides w3-animate-fading" src="<?php echo e(URL::asset('/images/ld4.jpeg')); ?>" style="width:100%">
  <img class="mySlides w3-animate-fading" src="<?php echo e(URL::asset('/images/ld5.jpeg')); ?>" style="width:100%">
</div>
...
<p align="center"><a class="btn btn-default" href="<?php echo e(url('/select')); ?>" role="button">Take The Test</a>
</p>  
            </div>
            </div>
